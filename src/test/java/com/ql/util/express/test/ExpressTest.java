...
public class ExpressTest {
    ...
    public void myTest() throws Exception {
        ...
        QLExpressRunStrategy.setNullValueToNumber(true);

        DefaultContext<String, Object> context = new DefaultContext<>();

        context.put("amt", new BigDecimal("20"));
        context.put("mult", new BigDecimal("10"));
        context.put("price", new BigDecimal("1325.52"));
        context.put("fee", new BigDecimal("5"));
        context.put("benefit", new BigDecimal("121200.2"));



        String src = "benefit + amt * mult * price  - amt * fee + profit";

        Object profit = runner.execute(src, context, null, false, true).toString();
        ...
        src = "benefit + amt * mult * price  - amt * fee - profit";

        profit = new BigDecimal(runner.execute(src, context, null, false, true).toString());
